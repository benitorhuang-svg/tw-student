...
import { AtlasTabs } from '@/domains/atlas'
import { CountyTabPanel, OverviewTabPanel, TreemapChart } from '@/domains/analytics'
import type { TrendPoint } from '@/shared/lib/analytics'
import type { useAtlasDerivedState } from '@/app/providers'
import { SchoolDataTable, SchoolDetailPanel } from '@/domains/education'
import type {
  RegionGroupFilter,
  AcademicYear,
...
import type { InvestigationItem, SavedComparisonScenario, InvestigationFilter } from '@/shared/lib/atlas'

// Styles
import '@/shared/ui/styles/templates/dashboard-shell/01-premium-cards-system.css'
        ...
        <div className="side-shell__body" ref={sidebarRef}>
          ...
          {activeTab === 'overview' && (
            <OverviewTabPanel
              ...
              renderTreemapChart={(chartProps) => <TreemapChart {...chartProps} />}
            />
          )}
          ...
          {(activeTab === 'schools' || activeTab === 'school-focus') && (
            <div className="dashboard-side-shell__content dashboard-side-shell__content--schools">
              <SchoolDetailPanel
                ...
                renderSchoolDataTable={(tableProps) => <SchoolDataTable {...tableProps} />}
              />
            </div>
          )}
        </div>
