import { formatAcademicYear } from '@/shared/lib/analytics'
import type { AcademicYear, EducationLevelFilter, ManagementTypeFilter, RegionGroupFilter } from '@/shared/lib/atlas'
import {
  EDUCATION_LEVELS,
  MANAGEMENT_TYPES,
