...
} from './TownshipDistributionSection'
import { ButterflyChart } from '@/shared/ui/core/molecules/ButterflyChart'
import AccordionItem from '@/shared/ui/core/atoms/AccordionItem'
import { getCountyStructureDistribution, type RankingSummary, type ScopeSummary } from '@/shared/lib/analytics'
import type { AcademicYear, CountySummaryRecord } from '@/shared/api/data/educationData'

type CountyDerivedState = {
  selectedCounty: CountySummaryRecord | null
  filters: { year: AcademicYear } | null
  townshipRows: RankingSummary[]
  selectedCountySummary: Pick<ScopeSummary, 'students'> | null
}

type CountyTabPanelProps = {
  derived: CountyDerivedState
