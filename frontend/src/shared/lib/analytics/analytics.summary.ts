import { ACADEMIC_YEARS, buildSummaryBucketKey, type AcademicYear, type CountyRecord, type CountySummaryRecord, type EducationLevelFilter, type ManagementTypeFilter, type RegionGroup } from '../../api/data/educationData'
import type {
