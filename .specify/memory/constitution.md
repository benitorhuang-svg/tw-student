...
- **檔案原子化與程式碼行數上限**: 所有程式碼檔案應遵循原子化設計原則；若單一檔案超過 300 行，開發者應評估是否可以透過拆分降低複雜度、改善可測試性與職責單一性。任何拆分或重構必須遵守 SOLID 原則，並在對應的 `specs/` 子目錄中記錄拆分理由、模組邊界與測試驗證步驟。

**版本**: 1.2.0 | **核准日期**: 2026-03-07 | **最後修訂**: 2026-03-08
